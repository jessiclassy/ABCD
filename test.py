...
cfg = {
    ...
    "inverse_label_weights": [
        ...
        0.41641111,
        0.21349426,
    ],  # inverse label weights for MinWiki since we are using MinWiki pre-trained model
}
...
start = time.time()
test_db = ComplexSentenceDL_Inference(
    cfg["root_dir"] + "data/",
    cfg["data_filename"],
